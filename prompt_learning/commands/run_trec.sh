...
for seed in 0  ; do
for train_seed in   0 21 42 87 100 200 300; do # 128 0 21 42 87 100
...
for al_method_first in  cal margin margin-km  ; do #margin margin-km kmeansw tpc kmeans   kmeansw tpc kmeans entropy cal bertkm coreset bald badge kmeansw tpc
for a in 0.3; do  #0.3 0.1
for b in 1 ; do #0.1 0.5 0 1 5 
for c in 0.2 ; do
